...
import { addSubject, updateSubject, deleteSubject } from './subjectSlice'
...
const data = useSelector((state) => state.subjects);    
    ...
    const handleSaveButton = () => {
        ...
        //     }
        // }
        console.log("info before addSubject", info);
        dispatch(
            addSubject({
                ...info,
            })
        );
        console.log("info after addSubject", data.subjectList);
        setInfo(initState)
    }
